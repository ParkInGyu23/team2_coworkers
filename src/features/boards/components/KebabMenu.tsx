  ...
  return (
    <Dropdown>
      ...
      <Dropdown.Menu align="right" className="-mt-2 w-30">
        {showEdit && <Dropdown.Item onClick={onEdit} className='hover:rounded-t-2xl'>수정</Dropdown.Item>}

        {showDelete && <Dropdown.Item onClick={onDelete} className='hover:rounded-b-2xl'>삭제</Dropdown.Item>}
      </Dropdown.Menu>
    </Dropdown>
  );
}
